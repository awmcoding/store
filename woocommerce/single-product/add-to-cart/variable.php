...
<form class="variations_form cart" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint( $product->id ); ?>" data-product_variations="<?php echo esc_attr( json_encode( $available_variations ) ) ?>">
	...
	<?php else : ?>
		...
		<div class="variations">
				...
				?>
						  <p class="swatchtitlelabel"><?php if (isset($labeltext) && ($labeltext != '')) { echo $labeltext; } ?></p>
						<div class="value">
				<?php
							if (isset($attribute_display_type) && ($attribute_display_type  == "colororimage")) {
								...
								echo end( $attribute_keys ) === $attribute_name ? '<br />' : '';
//								<a class="reset_variations" href="#">' . __( 'Clear selection', 'wcva' ) . '</a>' : '';
				?>
						</div>
